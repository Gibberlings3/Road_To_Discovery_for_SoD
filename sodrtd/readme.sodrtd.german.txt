...
--INSTALLATION
--ÜBERSICHT ÜBER DAS VERFOLGTE WISSEN
...
- Edwin soll Ifearnan (einschließlich seiner Pläne) im Wahrsagungsbecken identifizieren, bevor er ihn in Persona getroffen hat;
- die Herzöge den gefallenen Paladin Dauston befragen lassen, um mehr über Caelars Hintergrund – und seine Motive – zu erfahren;
...
Hinweis: Diese Komponente funktioniert auch ohne eine der anderen Komponenten. Die Komponente 2 „Hauptkomponente“ stellt auch die benötigten grundlegenden Tracking-Variablen für die aufgelisteten Ereignisse im Spiel bereit, falls diese Komponente nicht installiert ist. Die Installation von Komponente 1 (oder der gleichen Komponente von „Themed Tweaks“) wird für das gesamte Spielerlebnis empfohlen.
...
Nichtsdestotrotz konzentriert sich diese Komponente darauf, das Wissen der Offiziere über die Ziele und Geheimnisse des Kreuzzuges auf ein absolutes Minimum zu beschränken, um die Spielerfahrung nicht dadurch zu beeinträchtigen, dass der HC derjenige ist, der die wirklich entscheidenden Informationen preisgibt.
...
1 - HC erkennt die Existenz des Kreuzzuges an, der durch die Ländereien wütet
2 - HC weiß, dass sie die Seelen aus dem Drachenspeerkrieg von Avernus befreien wollen
3 - HC weiß, dass sie planen, in Avernus einzumarschieren
4 - HC weiß, dass sie vorhaben, in Burg Drachenspeer ein Portal zu öffnen, um nach Avernus zu gelangen
...
0 - HC hat das Gerücht noch nicht gehört
1 - HC hat Gerücht über Caelar/göttliche Kräfte durch Caelar gehört, die den Kreuzzug schützen
...
--Ifearnans Verrat ("C#RtD_IfearnanBetrayal"):
...
--Ifearnans echter Meister ("C#RtD_IfearnanFiend"):
...
-Wer ist „Ifearnan“? ("C#RtD_IfearnanIdentity"):
...
-HC hat Ifearnans Namen gehört ("C#RtD_IfearnanName"):
0 - HC hat Ifearnans Namen nie gehört
1 - HC hat Ifearnans Namen in Verbindung mit Caelar gehört

-HC sah Ifearnans Gesicht ("C#RtD_IfearnanVisual"):
0 - HC hat das Gesicht von Ifearnan nie gesehen
1 - HC weiß, dass [ein Mann, der wie] Ifearnan aussieht, mit der Schattenübereinkunft/einem Teufel zusammenarbeitet
...
2 - HC weiß, dass das Blut des Bhaal-Kindes notwendig/ausreichend ist, um das Portal nach Avernus unter der Burg zu öffnen
...
0 - HC weiß nicht, dass Caelar / Ifearnan das Blut des Bhaal-Kindes des HC [für etwas] will
...
Wissen über Herzöge und Bündnisoffiziere:
------------------------------------------
...
2 - Herzöge und Offiziere haben es woanders gehört/ sich selbst abgezogen (z. B. nachdem sie gehört haben, dass Bhaal-Blut benötigt wird, um das Portal zu öffnen oder nachdem "CaelarWantsHC" "1" ist)

--Caelars Plan ("C#RtD_CoalCaelarPlan"):
1 - Herzöge und Offiziere haben die Existenz des Kreuzzuges, der in den Ländern wütet, anerkannt 
-Portal unter Burg Drachenspeer und wie man es öffnet ("C#RtD_CoalKnowsPortalBlood"):
1 - Herzöge und Offiziere hörten von einem Portal/Spalt in der Burg Drachenspeer – HC erzählte es ihnen
2 - Herzöge und Offiziere haben von einem Portal/Spalt in der Burg Dragonspear gehört – sie haben es woanders gehört 
3 - Herzöge und Offiziere wissen, dass das Blut des Bhaal-Kindes benötigt wird/ausreicht, um das Portal nach Avernus unter der Burg zu öffnen – der HC hat es ihnen erzählt
4 - Herzöge und Offiziere wissen, dass das Blut des Bhaal-Kindes notwendig/ausreichend ist, um das Portal nach Avernus unter der Burg zu öffnen – sie haben es woanders gehört 
...
7 - Herzöge und Offiziere wissen, dass diese Caelar / Ifearnan das Blut des HCs dafür wollen – HC hat es ihnen erzählt -- auch für [C#RtD_CoalWantBhaalBlood = 5]
8 - Herzöge und Offiziere wissen, dass dieser Caelar / Ifearnan dafür HCs Blut plant – er hat es anderswo gehört – auch für [C#RtD_CoalWantBhaalBlood = 6]

--HC traf den vermummten Mann ("C#RtD_CoalMetHoodedMan"):
1 - Dukes und Beamte wissen, dass HC den Kapuzenmann getroffen hat – HC hat es ihnen erzählt
2 - Dukes und Beamte wissen, dass HC den Kapuzenmann getroffen hat – sie haben es woanders gehört
3 - Die Dukes und die Beamten wissen, dass der HC den Kapuzenmann mehr als einmal getroffen hat – der HC hat es ihnen erzählt
4 - Die Dukes und die Beamten wissen, dass der HC den Kapuzenmann mehr als einmal getroffen hat – er hat es woanders gehört
...
5 - Herzöge und Offiziere wissen, dass Caelar / Ifearnan das Blut des Bhaal-Kindes des HCs wollen, um das Portal zu öffnen – HC hat es ihnen gesagt – HC hat es ihnen gesagt – auch für [C#RtD_CoalKnowsPortalBlood = 7]
...
Anmerkung: „C#“ ist mein persönliches Präfix. Die Tracking-Variablen sollten so verwendet werden, wie sie in „Road to Discovery“ benannt sind. Aber für eigene Mod-Projekte sollte man sein eigenes Präfix verwenden. Wenn du noch kein persönliches Präfix hast, registriere eines für dich (Link unten).
...
Diese Mod wurde erstellt, um von allen Baldur's-Gate-II-Spielern frei genutzt werden zu können, und ihr Inhalt ist frei von Rechten. Der Inhalt ist frei von Rechten. Er darf jedoch nicht ohne die Zustimmung der Autoren verkauft, veröffentlicht, zusammengestellt oder in irgendeiner Form weitergegeben werden.
...
Es gibt zwei große Möglichkeiten, diese Harmonie zu stören. Die eine ist, die Arbeit eines anderen als die eigene zu beanspruchen. Die zweite ist, eine Mod ohne die Erlaubnis des Autors/der Autoren zu hosten und weiterzuverbreiten.
...
Diese Mod wird auch nicht von BioWare, Black Isle Studios, Interplay Entertainment Corp., Overhaul Games oder Beamdog entwickelt, unterstützt oder gebilligt. Alle anderen Marken und Copyrights sind Eigentum der jeweiligen Besitzer.
================================================================================